...
export default function PullToRefresh({ onRefresh, children }) {
  ...
  useEffect(() => {
    ...
    function onTouchStart(e) {
      // Radix portal(Dialog/Select/DropdownMenu)·토스트 안에서 시작된 터치는 무시
      // (모달 안 스크롤이 PullToRefresh에 가로채여 끊기는 문제 방지 —
      //  Dialog 콘텐츠는 role="dialog", Select/Dropdown 팝업은 popper wrapper로 식별)
      if (e.target.closest?.('[role="dialog"], [data-radix-popper-content-wrapper], [data-sonner-toaster], .pull-isolate')) return;
