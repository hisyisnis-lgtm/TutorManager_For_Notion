...
import { CaretLeftIcon, StairsIcon, LightningIcon, LockSimpleIcon, CaretRightIcon } from '@phosphor-icons/react';
...
export function ModeScreen({ endlessUnlocked, onDifficulty, onEndless, onBack, onLocked }) {
  return (
    <>
