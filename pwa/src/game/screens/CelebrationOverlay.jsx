...
export function CelebrationOverlay({ achievement, remaining = 0, onNext }) {
  ...
  return (
    <div onClick={onNext} style={{ position: 'fixed', inset: 0, zIndex: 300, background: 'rgba(26,16,20,0.62)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24, overflow: 'hidden', ...TOUCH_OPT }}>
      <style>{`
