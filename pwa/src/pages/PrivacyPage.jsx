          ...
          <Section icon={<CookieIcon weight="fill" />} title="8. 자동 수집 장치의 운영">
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              <BulletList items={[
                ...
                '통합웹·게임의 방문, 관심·문의 링크 클릭, 플레이 시작·완료를 30분 유효한 무작위 세션 ID로 연결해 측정합니다. 이름·연락처·전체 URL은 분석 이벤트에 포함하지 않습니다.',
                '세션 ID는 탭 저장소에 보관하며 공식 게임 이동 링크에 임시 전달된 값은 도착 후 URL에서 제거합니다. 브라우저의 Do Not Track 또는 Global Privacy Control 설정을 존중합니다.',
                '분석 기록은 Cloudflare Analytics Engine에서 3개월 보관합니다. 클릭 수는 실제 상담 접수나 매출이 아닙니다.',
              ]} />
              <NoteList items={[
