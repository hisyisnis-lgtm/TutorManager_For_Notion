...
// 기존 동의서의 원문을 그대로 옮긴다. 공개 프런트엔드에서 import하지 않는다.
const terms = {
  "teacherCancellation": "강사의 사정으로 당일 취소 시, 취소된 수업 시간뿐만 아니라 해당하는 시간만큼 무료 보강을 추가로 진행해 드립니다.",
  "refundBefore": "첫 수업 시작 전 환불 요청 시 전액 환불이 가능합니다.",
  "refundAfter": [
